...
# 读取灰度图
img_path = r"readtest100_origin.jpg"
...
# 保存结果
output_path = r"D:\PythonProject2\holo_new2_3level_100-100\output\readtest_origin_annotated_dominant.png"
cv2.imwrite(output_path, img_color)
print(f"带标注图像已保存: {output_path}")

# 保存等级数组
excel_path = r"D:\PythonProject2\holo_new2_3level_100-100\output\\origin_gray_levels_dominant.xlsx"
